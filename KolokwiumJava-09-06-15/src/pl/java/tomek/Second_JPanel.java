	...
	public Second_JPanel() {
		...
		btnZatwierdz.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				Ulgowy ulgowy_obiekt = new Ulgowy(1.5,Integer.parseInt(textField.getText()));
				...
				{
				Tygodniowy tygodniowy_obiekt = new Tygodniowy(10.5,Integer.parseInt(textField.getText()));
				...
				{
				Studencki Studencki_obiekt = new Studencki(0.5,Integer.parseInt(textField.getText()));
